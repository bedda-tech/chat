...
export const myProvider = isTestEnvironment
  ...
  : customProvider({
      languageModels: {
        ...
        "xai-grok-2-vision-1212": gateway.languageModel(
        ...
        "openai-gpt-5-chat-latest": gateway.languageModel(
          "openai/gpt-5-chat-latest"
        ),

        // Anthropic Models
        "anthropic-claude-opus-4-1": gateway.languageModel(
          "anthropic/claude-opus-4-1"
        ),
        "anthropic-claude-opus-4-0": gateway.languageModel(
          "anthropic/claude-opus-4-0"
        ),
        "anthropic-claude-sonnet-4-0": gateway.languageModel(
          "anthropic/claude-sonnet-4-0"
        ),
        "anthropic-claude-3-7-sonnet-latest": gateway.languageModel(
          "anthropic/claude-3-7-sonnet-latest"
        ),
        "anthropic-claude-3-5-haiku-latest": gateway.languageModel(
          "anthropic/claude-3-5-haiku-latest"
        ),

        // Mistral Models
        "mistral-pixtral-large-latest": gateway.languageModel(
          "mistral/pixtral-large-latest"
        ),
        "mistral-large-latest": gateway.languageModel(
          "mistral/mistral-large-latest"
        ),
        "mistral-medium-latest": gateway.languageModel(
          "mistral/mistral-medium-latest"
        ),
        "mistral-medium-2505": gateway.languageModel(
          "mistral/mistral-medium-2505"
        ),
        "mistral-small-latest": gateway.languageModel(
          "mistral/mistral-small-latest"
        ),
        "mistral-pixtral-12b-2409": gateway.languageModel(
          "mistral/pixtral-12b-2409"
        ),

        // Google Generative AI Models
        "google-gemini-2.5-flash-image": gateway.languageModel(
          "google/gemini-2.5-flash-image-preview"
        ),
        "google-gemini-2.0-flash-exp": gateway.languageModel(
        ...
        "google-vertex-gemini-2.0-flash-exp": gateway.languageModel(
          "google-vertex/gemini-2.0-flash-exp"
        ),
        "google-vertex-gemini-1.5-flash": gateway.languageModel(
          "google-vertex/gemini-1.5-flash"
        ),
        "google-vertex-gemini-1.5-pro": gateway.languageModel(
          "google-vertex/gemini-1.5-pro"
        ),

        // DeepSeek Models
        "deepseek-chat": gateway.languageModel("deepseek/deepseek-chat"),
        "deepseek-reasoner": gateway.languageModel(
        ...
        // Groq Models
        "groq-llama-4-scout-17b-16e-instruct": gateway.languageModel(
          "groq/meta-llama/llama-4-scout-17b-16e-instruct"
        ),
        "groq-llama-3.3-70b-versatile": gateway.languageModel(
          "groq/llama-3.3-70b-versatile"
        ),
        "groq-llama-3.1-8b-instant": gateway.languageModel(
          "groq/llama-3.1-8b-instant"
        ),
        "groq-mixtral-8x7b-32768": gateway.languageModel(
